...
const {
    uploadContent,getContent, getContentDetails,getComments,addComment,getLike,addLike,updateViewCount,searchContent
} = require("../controllers/contentController");
const { isAuthenticatedUser,isAVerifiedUser, authorizeRole } = require("../middleware/auth");
